export declare enum KaiheilaCMD {
    msg = 0,
    handshake = 1,
    ping = 2,
    pong = 3,
...
export declare type KaiheilaEvent = KHSystemMessage | KHTextMessage | KHImageMessage | KHVideoMessage | KHFileMessage | KHAudioMessage | KHKMarkDownMessage;
...
export declare type KaiheilaWebhookRequest = KaiheilaEncryptRequest | KaiheilaEventRequest;
export {};
